...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Dobavljaci", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Izlazi", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.IzlazStavke", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.JediniceMjere", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Korisnici", b =>
                {
                    b.Property<int>("KorisnikId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.KorisniciUloge", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Kupci", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.NarudzbaStavke", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Narudzbe", b =>
                {
                    b.Property<int>("NarudzbaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Ocjene", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Proizvodi", b =>
                {
                    b.Property<int>("ProizvodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Skladistum", b =>
                {
                    b.Property<int>("SkladisteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Ulazi", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.UlazStavke", b =>
                {
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Uloge", b =>
                {
                    b.Property<int>("UlogaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.VrsteProizvodum", b =>
                {
                    b.Property<int>("VrstaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Izlazi", b =>
                {
                    b.HasOne("RS2_Vjezba.Services.Database.Korisnici", "Korisnik")
                        .WithMany("Izlazis")
                        .HasForeignKey("KorisnikId")
                        .IsRequired()
                        .HasConstraintName("FK_Izlazi_Korisnici");

                    b.HasOne("RS2_Vjezba.Services.Database.Narudzbe", "Narudzba")
                        .WithMany("Izlazis")
                        .HasForeignKey("NarudzbaId")
                        .HasConstraintName("FK_Izlazi_Narudzbe");

                    b.HasOne("RS2_Vjezba.Services.Database.Skladistum", "Skladiste")
                        .WithMany("Izlazis")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.IzlazStavke", b =>
                {
                    b.HasOne("RS2_Vjezba.Services.Database.Izlazi", "Izlaz")
                        .WithMany("IzlazStavkes")
                        .HasForeignKey("IzlazId")
                        .IsRequired()
                        .HasConstraintName("FK_IzlazStavke_Izlazi");

                    b.HasOne("RS2_Vjezba.Services.Database.Proizvodi", "Proizvod")
                        .WithMany("IzlazStavkes")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasOne("RS2_Vjezba.Services.Database.Uloge", "Uloga")
                        .WithMany("KorisniciUloges")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Narudzbe", b =>
                {
                    b.HasOne("RS2_Vjezba.Services.Database.Kupci", "Kupac")
                        .WithMany("Narudzbes")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Proizvodi", b =>
                {
                    b.HasOne("RS2_Vjezba.Services.Database.JediniceMjere", "JedinicaMjere")
                        .WithMany("Proizvodis")
                        .HasForeignKey("JedinicaMjereId")
                        .IsRequired()
                        .HasConstraintName("FK_Proizvodi_JediniceMjere");

                    b.HasOne("RS2_Vjezba.Services.Database.VrsteProizvodum", "Vrsta")
                        .WithMany("Proizvodis")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.Ulazi", b =>
                {
                    b.HasOne("RS2_Vjezba.Services.Database.Dobavljaci", "Dobavljac")
                        .WithMany("Ulazis")
            ...
            modelBuilder.Entity("RS2_Vjezba.Services.Database.UlazStavke", b =>
                {
                    ...
                    b.HasOne("RS2_Vjezba.Services.Database.Ulazi", "Ulaz")
                        .WithMany("UlazStavkes")
